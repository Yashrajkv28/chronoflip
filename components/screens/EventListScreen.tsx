...
const EventListScreen: React.FC<EventListScreenProps> = ({
  ...
  return (
    <div className="h-[100dvh] flex flex-col overflow-hidden">
      {/* Top-left mode cycle button (matching v1 position) */}
      <button
        type="button"
